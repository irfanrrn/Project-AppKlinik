                      ...
                      <div className="card-body px-4 py-4-5">
                        <div className="row">
                          ...
                          <div className="col-md-8">
                            <h6 className="text-muted font-semibold">Doctor</h6>
                    ...
                    <div className="card">
                      <div className="card-body px-4 py-4-5">
                        <div className="row">
                          ...
                          <div className="col-md-8">
                            <h6 className="text-muted font-semibold">Nurse</h6>
                      ...
                      <div className="card-body px-4 py-4-5">
                        <div className="row">
                          ...
                          <div className="col-md-8">
                            ...
                            <h6 className="font-extrabold mb-0">30</h6>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="card-body py-4 px-5">
                    <div className="d-flex align-items-center">
                      ...
                      <div className="ms-3 name">
                        ...
                        <h6 className="text-muted mb-0">admin@admin.com</h6>
                      </div>
                    </div>
                  </div>
                </div>
