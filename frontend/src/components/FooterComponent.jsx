                        ...
                        <div className="row">
                            <div className="col-xl-4 col-md-6 col-lg-4">
                                <div className="footer-widget">
                                    ...
                                    <p>
                                        Our Clinic, where you can get quality
                                        and trusted health care. We are a clinic
                            ...
                            <div className="col-xl-4 col-md-6 col-lg-4">
                                <div className="footer-widget mt-4 mt-lg-0 d-flex align-items-start align-items-lg-center flex-column">
                                    <h3 className="footer-title-use mb-3">
                                        Useful Links
                                    </h3>
                                    <ul className="list">
                                        <li>
                            ...
                            <div className="col-xl-4 col-md-6 col-lg-4">
                                <div className="footer-widget">
                                    ...
                                    <p className="mb-2">
                                        ...
                                        Kalisombo Street No 18, Salatiga,
                                        Central Java
                                    </p>
                                    <p className="mb-2">
