...
import MdDocImg6 from "../assets/img/dokter/dr.sinta.jpg";
            ...
            <Card className="shadow-sm border-2">
              <Card.Body>
                <Row className="align-items-center">
                  ...
                  <Col md={8}>
                    <p className="mb-2">
                      <strong>Name :</strong> Dr. Sinta Dewi, Sp.KJ
                    </p>
                    <p className="mb-2">
                      <strong>Phone Number :</strong> 123456789098
                    </p>
                    <p className="mb-2">
                      <strong>Specialist :</strong> Psychology
                    </p>
                  </Col>
                </Row>
              </Card.Body>
