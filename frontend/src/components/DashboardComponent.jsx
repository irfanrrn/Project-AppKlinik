        ...
        <ul className="menu">
          ...
          <li className="sidebar-item  has-sub">
            ...
            <ul className="submenu ">
              ...
              <li className="submenu-item  ">
                <a href="component-breadcrumb.html" className="submenu-link">
                  Breadcrumb
                </a>
              </li>
              <li className="submenu-item  ">
              ...
              <li className="submenu-item  ">
                <a href="component-list-group.html" className="submenu-link">
                  List Group
                </a>
              </li>
              <li className="submenu-item  ">
              ...
              <li className="submenu-item  ">
                <a href="component-pagination.html" className="submenu-link">
                  Pagination
                </a>
              </li>
              <li className="submenu-item  ">
                <a href="component-placeholder.html" className="submenu-link">
                  Placeholder
                </a>
              </li>
              <li className="submenu-item  ">
          ...
          <li className="sidebar-item  has-sub">
            ...
            <ul className="submenu ">
              <li className="submenu-item  ">
                <a href="extra-component-avatar.html" className="submenu-link">
                  Avatar
                </a>
              </li>
              <li className="submenu-item  ">
                <a href="extra-component-comment.html" className="submenu-link">
                  Comment
                </a>
              </li>
              <li className="submenu-item  ">
                <a href="extra-component-divider.html" className="submenu-link">
                  Divider
                </a>
              </li>
              <li className="submenu-item  ">
              ...
              <li className="submenu-item  ">
                <a href="extra-component-flag.html" className="submenu-link">
                  Flag
                </a>
              </li>
              <li className="submenu-item  ">
              ...
              <li className="submenu-item  ">
                <a href="extra-component-rating.html" className="submenu-link">
                  Rating
                </a>
              </li>
            </ul>
          ...
          <li className="sidebar-item  has-sub">
            ...
            <ul className="submenu ">
              ...
              <li className="submenu-item  ">
                <a href="layout-vertical-navbar.html" className="submenu-link">
                  Vertical Navbar
                </a>
              </li>
              <li className="submenu-item  ">
          ...
          <li className="sidebar-item  has-sub">
            ...
            <ul className="submenu ">
              ...
              <li className="submenu-item  ">
                <a href="form-element-checkbox.html" className="submenu-link">
                  Checkbox
                </a>
              </li>
              <li className="submenu-item  ">
                <a href="form-element-textarea.html" className="submenu-link">
                  Textarea
                </a>
              </li>
            </ul>
          ...
          <li className="sidebar-item  has-sub">
            ...
            <ul className="submenu ">
              <li className="submenu-item  ">
                <a href="form-validation-parsley.html" className="submenu-link">
                  Parsley
                </a>
              </li>
            </ul>
          ...
          <li className="sidebar-item  has-sub">
            ...
            <ul className="submenu ">
              ...
              <li className="submenu-item  ">
                <a href="form-editor-ckeditor.html" className="submenu-link">
                  CKEditor
                </a>
              </li>
              <li className="submenu-item  ">
                <a href="form-editor-summernote.html" className="submenu-link">
                  Summernote
                </a>
              </li>
              <li className="submenu-item  ">
          ...
          <li className="sidebar-item  has-sub">
            ...
            <ul className="submenu ">
              ...
              <li className="submenu-item  ">
                <a href="table-datatable-jquery.html" className="submenu-link">
                  Datatable (jQuery)
                </a>
              </li>
            </ul>
          ...
          <li className="sidebar-item  has-sub">
            ...
            <ul className="submenu ">
              ...
              <li className="submenu-item  ">
                <a href="ui-icons-fontawesome.html" className="submenu-link">
                  Fontawesome
                </a>
              </li>
              <li className="submenu-item  ">
            ...
            <ul className="submenu ">
              <li className="submenu-item  has-sub">
                ...
                <ul className="submenu submenu-level-2 ">
                  <li className="submenu-item ">
                    <a href="ui-multi-level-menu.html" className="submenu-link">
                      Second Level
                    </a>
                  </li>
                </ul>
          ...
          <li className="sidebar-item  has-sub">
            ...
            <ul className="submenu ">
              ...
              <li className="submenu-item  ">
                <a href="auth-forgot-password.html" className="submenu-link">
                  Forgot Password
                </a>
              </li>
            </ul>
