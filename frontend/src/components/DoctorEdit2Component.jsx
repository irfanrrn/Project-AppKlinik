...
const DoctorEdit2Component = () => {
  ...
  const [doctorData, setDoctorData] = useState({
    ...
    image: "dokterImg2.jpg", // Initial image source
  });
        ...
        <Modal.Body>
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group controlId="formImage">
              ...
              <Image src={dokterImg2} alt="Doctor" thumbnail className="mb-3" />
              <Form.Control
                type="file"
                name="image"
...
export default DoctorEdit2Component;
