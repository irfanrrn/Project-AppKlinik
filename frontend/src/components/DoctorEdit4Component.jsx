...
const DoctorEdit4Component = () => {
  const [showModal, setShowModal] = useState(false);
  const [doctorData, setDoctorData] = useState({
    name: "Dr. Maya Putri, Sp.JP",
    id: "123456789098",
    specialty: "Heart Specialist",
    description: "Specialist in Cardiology",
    image: "dokterImg1.jpg", // Initial image source
  });
        ...
        <Modal.Body>
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group controlId="formImage">
              ...
              <Image src={dokterImg1} alt="Doctor" thumbnail className="mb-3" />
              <Form.Control
                type="file"
                name="image"
...
export default DoctorEdit4Component;
