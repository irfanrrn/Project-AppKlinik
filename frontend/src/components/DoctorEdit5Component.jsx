...
export const DoctorEdit5Component = () => {
  ...
  const [doctorData, setDoctorData] = useState({
    ...
    image: "dokterImg3", // Initial image source
  });
        ...
        <Modal.Body>
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group controlId="formImage">
              ...
              <Image src={dokterImg3} alt="Doctor" thumbnail className="mb-3" />
              <Form.Control
                type="file"
                name="image"
...
export default DoctorEdit5Component;
